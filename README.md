...
Após fazer o download do arquivo .zip, extraia a pasta do projeto. Em seguida, abra a pasta no VS Code.No terminal do VS Code, entre na pasta principal do projeto utilizando o comando: cd .\Snake-Hungry\ 
